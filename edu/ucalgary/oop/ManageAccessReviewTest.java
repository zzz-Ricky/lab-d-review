...
public class ManageAccessReviewTest {

    public String[] logFile = {
            "20230102.083202 User:A766 Door:631",
            "20230102.095501 User:B660 Door:802",
            "20230102.100020 User:C660 Door:812",
            "20230202.110159 User:CY60 Door:230",
            "20230202.114830 User:A766 Door:030",
            "20230203.125930 User:A766 Door:230",
            "20230203.125930 User:CY60 Door:230",
            "20230204.143018 User:B950 Door:601",
            "20230204.161808 User:C660 Door:631",
            "20230204.180412 User:A766 Door:631"
    };

    public String logLine = "20230210.070000 User:F119 Door:002";
        
    public ManageAccessReviewTest() { }
    ...
    public void testAccessLogConstructorInvalidData() {
        ...
        try{
            AccessLog accessLine = new AccessLog("20230203.125712G111111");
        }
    ...
    public void testSetUserID() {
        AccessLog accessLine = new AccessLog(logLine);
        accessLine.setUserID("H213");
        String foundUserID = accessLine.getUserID();
        String expectedUserID = "H213";
    ...
    public void testSetDoorID() {
        AccessLog accessLine = new AccessLog(logLine);
        accessLine.setDoorID("010");
        String foundDoorID = accessLine.getDoorID();
        String expectedDoorID = "010";
